...
fn test_switch_manual_str() {
    ...
    if let Some(SwitchManualStr_Opcode_Body::SwitchManualStr_Opcode_Strval(s)) =  *r.opcodes()[0].body() {
    ...
    if let Some(SwitchManualStr_Opcode_Body::SwitchManualStr_Opcode_Intval(s)) =  *r.opcodes()[1].body() {
    ...
    if let Some(SwitchManualStr_Opcode_Body::SwitchManualStr_Opcode_Intval(s)) =  *r.opcodes()[2].body() {
    ...
    if let Some(SwitchManualStr_Opcode_Body::SwitchManualStr_Opcode_Strval(s)) =  *r.opcodes()[3].body() {
        assert_eq!("", *s.value());
    } else {
        panic!("expected enum SwitchManualStr_Opcode_Strval");
    }
